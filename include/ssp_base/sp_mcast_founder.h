...
struct SSP_BASE_EXPORT stuMCastPackageReq
{
	WORD length;
	WORD start_word;
	WORD type;
...
struct SSP_BASE_EXPORT stuMCastUnitInfo
{
	DWORD unit_id;
...
struct SSP_BASE_EXPORT stuMCastPackageRes
{
	WORD length;
	WORD start_word;
	WORD type;
...
class SSP_BASE_EXPORT CMCastFounder : public SService
{
public:
