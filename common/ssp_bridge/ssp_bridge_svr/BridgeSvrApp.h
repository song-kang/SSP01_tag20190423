...
#ifndef __BRIDGE_SVR_APPLICATION_H__
#define __BRIDGE_SVR_APPLICATION_H__

#include "SApplication.h"
#include "BridgeSvr.h"

class CBridgeSvrApp : public SApplication 
{
public:
	CBridgeSvrApp();
	virtual ~CBridgeSvrApp();
...
#endif//__BRIDGE_SVR_APPLICATION_H__
