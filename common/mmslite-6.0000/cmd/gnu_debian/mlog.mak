...
# script.  								 #
#									 #
# To make the MLOG_L.A:						         #
# 	make -f mlog.mak     	   DFLAG=_l   DEFS=-DDEBUG_SISCO	 #
# To make the MLOG_N.A:						         #
# 	make -f mlog.mak   	   DFLAG=_n				 #
# To make the MLOG_LD.A:						 #
# 	make -f mlog.mak    OPT=-g DFLAG=_ld  DEFS=-DDEBUG_SISCO	 #
# To make the MLOG_ND.A:						 #
# 	make -f mlog.mak    OPT=-g DFLAG=_nd				 #
#									 #
# MODIFICATION LOG :	       						 #
#  Date     Who   Rev			Comments			 #
# --------  ---  ------   -------------------------------------------	 #
# 02/03/10  JRB    03     Del INCDIR, LIBDIR (now defined in platform.mak).
# 08/04/05  EJV    02     Moved platform defs to platform.mak.
#			  Revised link & clean. Added -c in compile rule.
# 07/22/05  GLB    01     Created from "mlogl.mak".			 #
##########################################################################
...
$(OBJDIR)/ml_defva.o : ml_defva.c $(INCLUDES)
$(OBJDIR)/ml_defvl.o : ml_defvl.c $(INCLUDES)
$(OBJDIR)/ml_deldo.o : ml_deldo.c $(INCLUDES)
$(OBJDIR)/ml_delea.o : ml_delea.c $(INCLUDES)
$(OBJDIR)/ml_delec.o : ml_delec.c $(INCLUDES)
$(OBJDIR)/ml_delee.o : ml_delee.c $(INCLUDES)
$(OBJDIR)/ml_delpi.o : ml_delpi.c $(INCLUDES)
$(OBJDIR)/ml_delse.o : ml_delse.c $(INCLUDES)
...
$(OBJDIR)/ml_frena.o : ml_fread.c $(INCLUDES)
