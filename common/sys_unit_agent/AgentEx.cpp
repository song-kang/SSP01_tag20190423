...
// 			pThisSession->AddSendPackage(sMsg);
	...
	else if(cmd == "cmd")
	{
		...
		else
		{
			...
			//pSessionParam->pSession->SendAndRecv(pSessionParam->pSession->GetSessionSock(),pSessionParam->pSession->NewPackage(SP_UA_MSG_PROC_TXT_CMD_REQ,(BYTE*)sCmdAll.data(),sCmdAll.length()+1),pRecvPackage,10);
